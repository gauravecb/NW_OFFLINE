sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/offlinetest/NW_Offline/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#Offline-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#Offline-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("com.sap.offlinetest.NW_Offline.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/offlinetest/NW_Offline/localService/mockserver"], function (mockserver) {
